...
class QuizGenerator:
    def __init__(self, topic=None, num_questions=1, vectorstore=None):
        ...
        self.llm = None
        self.json_parser = JsonOutputParser(pydantic_object=QuestionSchema)
    ...
    def generate_question_with_vectorstore(self):
        ...
        chain = setup_and_retrieval | prompt | self.llm | self.json_parser
    ...
    def generate_quiz(self) -> list:
        ...
        for _ in range(self.num_questions):
            print(f"------Round {_} to generate a question-------")
            ...
            if self.validate_question(question):
                ...
                #lets try 3 attempts to get a unique question
                for i in range(3):
                    ...
                    if self.validate_question(question):
                        ...
                        print("Again duplicate or invalid question detected.")
                        continue
    ...
    def validate_question(self, question: dict) -> bool:
        ...
        for ques_dict in self.question_bank:
            if ques_dict["question"] == question["question"]:
                    is_unique = False
                    break
